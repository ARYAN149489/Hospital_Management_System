      ...
      <body>
        <div class="header-container">
          ...
          <div class="hospital-details">
            ...
            123 Hospital Lane, Medical Center, NY 10001<br>
            Phone: +1 (555) 019-9876 | Email: info@medicareplus.com
          </div>
        </div>
        <div class="details-section">
          <div class="info-card">
            ...
            <div class="info-row"><span class="info-label">Patient ID:</span><span class="info-val">${rx.patient?.patientId || '—'}</span></div>
          </div>
          <div class="info-card">
            <h3>Consultation Details</h3>
            <div class="info-row"><span class="info-label">Doctor Name:</span><span class="info-val">${doctorName}</span></div>
            <div class="info-row"><span class="info-label">Department:</span><span class="info-val">${rx.doctor?.specialization || 'General'}</span></div>
            <div class="info-row"><span class="info-label">Prescription Date:</span><span class="info-val">${dateStr} · ${timeStr}</span></div>
            <div class="info-row"><span class="info-label">Diagnosis:</span><span class="info-val" style="color: #0f766e;">${rx.diagnosis || '—'}</span></div>
          </div>
        </div>
        ${vitalsHtml}
        ${complaintsHtml}
